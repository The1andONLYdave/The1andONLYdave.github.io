...
class ApplicationMain {
	...
	private static function preload() {
		...
		// assets
		loadFile("assets/art/area02_level_tiles2.png");
		loadFile("assets/art/bullet.png");
		loadFile("assets/art/coinspin.png");
		loadFile("assets/art/lizardhead3.png");
		loadFile("assets/art/lizgibs.png");
		loadFile("assets/art/lurkgibs.png");
		loadFile("assets/art/lurkmonsta.png");
		loadFile("assets/art/pointer.png");
		loadFile("assets/art/simples_pimples.png");
		loadFile("assets/art/spikegibs.png");
		loadFile("assets/art/spikemonsta.png");
		loadBinary("assets/data/coins.csv");
		loadBinary("assets/data/lurkcoords.csv");
		loadBinary("assets/data/monstacoords.csv");
		loadBinary("assets/data/monstacoords.txt");
		loadBinary("assets/levels/mapCSV_Group1_Ladders.csv");
		loadBinary("assets/levels/mapCSV_Group1_Map1.csv");
		loadBinary("assets/levels/mapCSV_Group1_Map1back.csv");
		loadSound("assets/music/ScrollingSpace.mp3");
		loadSound("assets/music/ScrollingSpace.ogg");
		loadSound("assets/sounds/badshoot.wav");
		...
		loadSound("assets/sounds/mondead2.wav");
		loadSound("assets/sounds/monhurt2.wav");
		loadSound("assets/sounds/shoot2.wav");
